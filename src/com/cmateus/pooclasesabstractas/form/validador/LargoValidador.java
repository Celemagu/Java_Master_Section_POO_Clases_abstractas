package com.cmateus.pooclasesabstractas.form.validador;
...
public class LargoValidador extends Validador implements MensajeFormateable{
	...
	public boolean esValido(String valor) {
		//this.mensaje= String.format(this.mensaje, this.min, this.max); // toma los valores del mensaje %d y los reemplaza por los valores this.min y this max respectivamente
		if (valor == null) {
			return true;
		}
